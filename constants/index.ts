...
export const experiences: Array<objectExperience> = [
  {
    ...
    bgLogo: '#ffff',
    desciption: ['r&d', 'suivi developpeur', 'revud de code', 'veille technologique', '.......... a completer'],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    poste: 'Proprietaire',
    bgLogo: '#ffff',
    desciption: ['Tout', 'gestion de stock', 'comptabilte', 'gestion des achets', 'gestion des clients', '...'],
  },
...
export type TechListType = { name: string; icon: StaticImageData; bgColor?: string | '#ffffff' }
...
export const TechList: Array<TechListType> = [
  ...
  { name: 'github', icon: github, bgColor: '#cacaca' },
  { name: 'jquery', icon: jquery },
  { name: 'haproxy', icon: haproxy },
  { name: 'kali', icon: kali, bgColor: '#000000' },
